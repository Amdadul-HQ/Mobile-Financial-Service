...
const uri = "mongodb+srv://rimonamdadul301:8enfTEuMZ1MRMN1w@cluster0.6vc9q5p.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
async function run() {
  try {
    ...
    app.post('/user',async(req,res)=>{
        ...
        const result = await usersCollection.insertOne({...user,pin:hasedPin})
        res.send(result)
    })
